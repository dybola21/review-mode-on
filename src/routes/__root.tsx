  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4f801336-9830-4ef8-9b3e-3c6dbdff151f/id-preview-8132633e--0bdb736b-8245-4c6a-baf0-160440128ae9.lovable.app-1784514482315.png",
      },
      {
        name: "twitter:image",
        content:
